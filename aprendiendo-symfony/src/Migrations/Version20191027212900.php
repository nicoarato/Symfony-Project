 ...
 */
final class Version20191027212900 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE animales ADD tipo VARCHAR(255) NOT NULL COLLATE latin1_swedish_ci, ADD color VARCHAR(255) NOT NULL COLLATE latin1_swedish_ci, ADD raza VARCHAR(255) NOT NULL COLLATE latin1_swedish_ci');
    }
}
